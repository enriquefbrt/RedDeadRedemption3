...
public class FireballBehavior : MonoBehaviour
{
    ...
    private GameObject fireball;  // This GameObject is the fireball (parent of FireballAnimator)
    ...
    {
        yield return new WaitForSeconds(0.525f); //middle of animation
        Animation.appear();
        isFlying = true;
        float flightTime = 2f;  // How long the fireball will fly
        Vector3 initialPosition = fireball.transform.parent.position - new Vector3(0.75f,0f,0f);  //Not right on the monster
        ...
        while (elapsedTime < flightTime)
        {
            ...
            fireball.transform.position = Vector3.Lerp(initialPosition, targetPosition, elapsedTime / flightTime);
